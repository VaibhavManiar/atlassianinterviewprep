...
public class ContentPopularityCalculator {
	...
	public static class Content {
		...
		public void decreasePopularity(int count) {
			...
			this.popularity.set(Math.max(newCount, 0));
			this.timestamp = System.currentTimeMillis();
		}
